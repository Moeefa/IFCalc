    ...
    <>
      ...
      <div className="flex flex-col min-h-screen overflow-hidden p-6 w-full">
        ...
        <main className="flex flex-col flex-1 relative my-6">
          ...
          >
            <div
              className="relative w-full h-full rounded-2xl overflow-hidden mb-6"
              style={{
            ...
            >
              <Image
                ...
                alt="PET Autonet"
                fill
                className="absolute top-0 left-0 blur-sm h-full w-full object-cover rounded-2xl"
              />
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black/30 rounded-2xl" />
