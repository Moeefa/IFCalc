  ...
  return (
    <>
      <footer className="h-20">
        <div className="dark:bg-background/50 bg-background/80 backdrop-saturate-150 backdrop-blur w-full h-16 fixed bottom-0 border-t border-default-200 dark:border-default-100">
